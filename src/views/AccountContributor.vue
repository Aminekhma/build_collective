<template lang="html">
  <div class="home">
    <form id="signup-from" style="border:1px solid #ccc">
      <div class="container">
            <h1> Ajouter des contributeurs </h1>
            <p> veuillez saisir les informations </p>

            <label for="name"><b>Name</b></label>
            <input type="text" v-model="nameMembers" placeholder = "name" name="name"/>
...
export default defineComponent({
  ...
  methods: {
    ...
    async submit() {
      ...
      await contract.methods.addContributeur(contract.methods.getUniqueId(), contract.methods.trouverIndex(contract.methods.getMaListeProject(address), address)).send()
      this.nameMembers = ''
    },
